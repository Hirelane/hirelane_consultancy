import cardBG from '../assets/blackCardBG.jpg'

const MissionVision = () => {
    return (
        <div className="flex flex-row justify-center mt-10 items-center gap-[150px]">
            <div className="flex flex-col justify-between items-center h-[500px] w-[600px] bg-black rounded-3xl shadow-lg">
            ...
            <div className="flex flex-col justify-between items-center h-[500px] w-[600px] bg-black rounded-3xl" >
