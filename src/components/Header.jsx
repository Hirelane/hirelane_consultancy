    ...
    <div className='flex flex-row justify-center pb-20' style={{
        ...
        <div className='w-[40%] ml-10 flex flex-col mt-[100px]'>
            ...
            <div className='w-[80%] flex flex-col gap-2'>
                <p className='font-light text-[1.2rem]'>Unlock unparalleled expertise with our curated pool of top-tier talent</p>
                <p className='font-light text-[1.2rem]'>Streamline your recruitment as we ensure your team is up and running in no time</p>
                <p className='font-light text-[1.2rem]'>Save on your budget with our cost-effective solutions</p>
            </div>
            <Link to='/howItWorks'><Button variant='contained' endIcon={<SendIcon />} className='w-[35%] py-4' 
            sx={{
                my: 5,
